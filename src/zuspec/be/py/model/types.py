...
class Action[T]:
    ...
    async def __call__(self, comp: Optional['Component'] = None,
        ...
        from zuspec.be.py.rt.action_infra import get_or_build_infra
        import dataclasses as dc
        import random
...
class BufferPool[T](Pool[T]):
    ...
    def fromList(items: List[T]) -> BufferPool[T]:
        from zuspec.be.py.rt.list_buffer_pool import ListBufferPool
...
class ClaimPool[T](Pool[T]):
    ...
    def fromList(resources: List[T]) -> 'ClaimPool[T]':
        ...
        from zuspec.be.py.rt.list_claim_pool import ListClaimPool
