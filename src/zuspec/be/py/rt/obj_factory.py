...
from zuspec.be.py.model.config import ObjFactory as ObjFactoryP
from zuspec.be.py.model.decorators import ExecProc, ExecSync, ExecComb, Input, Output
from zuspec.be.py.model.types import Component, Extern, Lock, Memory, AddressSpace, RegFile, Reg, U, S, Uptr, At
from zuspec.be.py.model.tlm import Channel, GetIF, PutIF, Transport
...
if TYPE_CHECKING:
    from zuspec.dataclasses import Event
...
class BindPath:
    ...
    def __getattr__(self, name):
        from zuspec.be.py.model.types import Component
        ...
        try:
            ...
            if isinstance(resolved, Component):
                from zuspec.be.py.model.domain import ClockDomain, ResetDomain, _ZdcDomainRef
...
#                namespace["__post_init__"] = cls.__dict__["__post_init__"]
            ...
            for f in dc.fields(cls):
                ...
                # Handle fixed-size tuple fields
                    ...
                    from zuspec.be.py.model.decorators import export as export_func, port as port_func
    ...
    def __comp_build__(comp, parent, name, timebase: Timebase, port_bindings: Dict[str, Any] = None):
        from zuspec.be.py.model.config import Config
    ...
    def __resolve_component_domain__(comp, parent):
        ...
        """
        try:
            from zuspec.be.py.model.domain import ClockDomain, ResetDomain
        except ImportError:
            return
        ...
        for klass in cls.__mro__:
            ...
            if 'clock_domain' in klass.__dict__:
                ...
                from zuspec.be.py.model.domain import _ClockDomainField
        ...
        for klass in cls.__mro__:
            ...
            if 'reset_domain' in klass.__dict__:
                ...
                if isinstance(val, ResetDomain):
                    own_rst = val
                    break
                from zuspec.be.py.model.domain import _ResetDomainField
