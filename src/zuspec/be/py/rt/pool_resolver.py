...
class PoolResolver:
    ...
    def resolve_pool(self, action: Any, field_name: str) -> Optional[Any]:
        ...
        if result is None:
            result = self._resolve_action_bind(action, field_name)
    ...
    def _resolve_action_bind(self, action: Any, field_name: str) -> Optional[Any]:
        ...
        """
        from zuspec.dataclasses.action_bind import parse_action_bind
...
def _action_comp_type(action_type: type) -> Optional[type]:
    ...
    import typing
    from zuspec.be.py.model.types import Action
