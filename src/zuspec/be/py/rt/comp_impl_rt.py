...
class CompImplRT(object):
    ...
    def handle_setattr(self, comp: Component, name: str, value):
        ...
        if hasattr(self, '_eval_initialized') and self._eval_initialized:
            ...
            from zuspec.be.py.model.decorators import Output
    ...
    def start_procs(self, comp: Component):
        ...
        for name, proc in self._proc_processes:
            if getattr(proc.method, '_zdc_async_pipeline', False):
                ...
                from zuspec.be.py.model.domain import ClockDomain
                ...
                from zuspec.dataclasses.pipeline_ns import _CURRENT_PROC_COMP
    ...
    async def _run_pipeline(comp, method, rt) -> None:
        ...
        """
        from zuspec.dataclasses.pipeline_ns import _PIPELINE_RT, _CURRENT_TOKEN, _CURRENT_STAGE_IDX
...
#        self.name = self.factory.name_s[-1]
    ...
    async def wait(self, comp: Component, amt = None):
        ...
        """
        from zuspec.be.py.model.types import Time
        tb = self.timebase()
