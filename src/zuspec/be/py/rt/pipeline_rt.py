...
from zuspec.dataclasses.pipeline_ns import (
    _PIPELINE_RT,
    _CURRENT_TOKEN,
    _CURRENT_STAGE_IDX,
    _CURRENT_STAGE,
...
class PipelineRuntime:
    ...
    def find(self, predicate: Callable) -> Optional[Any]:
        ...
        from zuspec.dataclasses.pipeline_ns import _Snap
...
def _make_lock_rt(lock):
    ...
    from zuspec.dataclasses.pipeline_locks import QueueLock, BypassLock, RenameLock
